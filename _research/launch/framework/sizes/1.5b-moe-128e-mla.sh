...
#
# 1.5b-moe-128e-mla — MLA twin of 1.5b-moe-128e (Multi-Latent Attention).
...
# lora ranks scaled at target ratios (kv ≈ hidden/14, q = 3×kv). ~0.38B active /
# ~1.53B total. Token budget = 100 tok/active-param. Routing policy in common.sh.
...
APERTUS_TRACK=1.5a-moe-128e-mla
