...
class TransformerConfig(ModelParallelConfig):
    ...
    """For the offloading experts, store the activations saved for backward (the permuted expert
    input, and the FC1 output when it is not recomputed) as blockwise FP8 and dequantize them in
    backward. Requires TransformerEngine."""
