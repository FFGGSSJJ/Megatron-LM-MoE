...
def num_floating_point_operations(args, batch_size):
    ...
    def transformer_flops():
        ...
        # pnglu/pn3glu/gxpr/gxpry/gxprv2/gxr2/xr2glu/xsssglu (PolyNorm-family and XPR-family GLU
        # gates) are also GLUs (fc1 is h->2*ffn_h), so they count as gated even though they do
        # not set args.swiglu.
        ffn_expansion_factor = 3 if (
            args.swiglu or args.pnglu or args.pn3glu or args.gxpr or args.gxpry or args.gxprv2
            or args.gxr2 or args.xr2glu or args.xsssglu
        ) else 2
    ...
    if is_hybrid_model(args):
        ...
        return hybrid_flops(
            ...
            # pnglu/pn3glu/gxpr/gxpry/gxprv2/gxr2/xr2glu/xsssglu are GLUs (gated) but do not set
            # args.swiglu
            swiglu=(
