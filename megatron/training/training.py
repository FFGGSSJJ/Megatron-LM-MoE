...
def num_floating_point_operations(args, batch_size):
    ...
    def transformer_flops():
        ...
        # pnglu/pn3glu/gxpr/gxpry/gxr2/xr2glu (PolyNorm-family and XPR-family GLU gates) are also
        # GLUs (fc1 is h->2*ffn_h), so they count as gated even though they do not set args.swiglu.
    ...
    if is_hybrid_model(args):
        ...
        return hybrid_flops(
            ...
            # pnglu/pn3glu/gxpr/gxpry/gxr2/xr2glu are GLUs (gated) but do not set args.swiglu
            swiglu=(
                args.swiglu or args.pnglu or args.pn3glu or args.gxpr or args.gxpry or args.gxr2
                or args.xr2glu
            ),
